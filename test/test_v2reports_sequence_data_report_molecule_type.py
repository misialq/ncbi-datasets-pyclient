...
class TestV2reportsSequenceDataReportMoleculeType(unittest.TestCase):
    """V2reportsSequenceDataReportMoleculeType unit test stubs"""
    ...
    def testV2reportsSequenceDataReportMoleculeType(self):
        """Test V2reportsSequenceDataReportMoleculeType"""
        # inst = V2reportsSequenceDataReportMoleculeType()
