...
class V2OrganelleDownloadRequest(BaseModel):
    ...
    exclude_sequence: Optional[StrictBool] = None
    include_annotation_type: Optional[List[V2AnnotationForOrganelleType]] = None
    __properties: ClassVar[List[str]] = ["accessions", "exclude_sequence", "include_annotation_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "exclude_sequence": obj.get("exclude_sequence"),
