...
class Ncbiprotddv2StructureDataReportExperiment(BaseModel):
    ...
    """ # noqa: E501
    experimental_method: Optional[StrictStr] = None
    resolution: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["experimental_method", "resolution"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Ncbiprotddv2StructureDataReportExperiment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Ncbiprotddv2StructureDataReportExperiment from a dict"""
        if obj is None:
            return None
