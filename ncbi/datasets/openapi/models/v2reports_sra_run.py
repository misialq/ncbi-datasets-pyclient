...
class V2reportsSraRun(BaseModel):
    ...
    expression_value: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["accession", "expression_value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expression_value": obj.get("expression_value")
        })
        return _obj
