...
class V2reportsGeneCounts(BaseModel):
    ...
    protein_coding: Optional[StrictInt] = None
    non_coding: Optional[StrictInt] = None
    pseudogene: Optional[StrictInt] = None
    other: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["total", "protein_coding", "non_coding", "pseudogene", "other"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "protein_coding": obj.get("protein_coding"),
            "non_coding": obj.get("non_coding"),
            "pseudogene": obj.get("pseudogene"),
            "other": obj.get("other")
        })
        return _obj
