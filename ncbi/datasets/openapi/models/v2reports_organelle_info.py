...
class V2reportsOrganelleInfo(BaseModel):
    ...
    infraspecific_name: Optional[StrictStr] = None
    bioproject: Optional[List[StrictStr]] = None
    description: Optional[StrictStr] = None
    total_seq_length: Optional[StrictStr] = None
    submitter: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["assembly_name", "infraspecific_name", "bioproject", "description", "total_seq_length", "submitter"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "infraspecific_name": obj.get("infraspecific_name"),
            "bioproject": obj.get("bioproject"),
            "description": obj.get("description"),
            "total_seq_length": obj.get("total_seq_length"),
