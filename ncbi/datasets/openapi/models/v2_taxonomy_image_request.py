...
class V2TaxonomyImageRequest(BaseModel):
    ...
    image_size: Optional[V2ImageSize] = V2ImageSize.UNSPECIFIED
    __properties: ClassVar[List[str]] = ["taxon", "image_size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "taxon": obj.get("taxon"),
            "image_size": obj.get("image_size") if obj.get("image_size") is not None else V2ImageSize.UNSPECIFIED
        })
        return _obj
