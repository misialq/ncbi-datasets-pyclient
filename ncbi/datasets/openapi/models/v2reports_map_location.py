...
class V2reportsMapLocation(BaseModel):
    ...
    """ # noqa: E501
    map_type: Optional[V2reportsMapLocationMapType] = V2reportsMapLocationMapType.UNKNOWN
    map_value: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["map_type", "map_value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "map_type": obj.get("map_type") if obj.get("map_type") is not None else V2reportsMapLocationMapType.UNKNOWN,
            "map_value": obj.get("map_value")
        })
        return _obj
