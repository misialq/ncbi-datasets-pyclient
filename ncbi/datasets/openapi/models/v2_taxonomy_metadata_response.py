...
class V2TaxonomyMetadataResponse(BaseModel):
    """
    V2TaxonomyMetadataResponse
    """ # noqa: E501
    messages: Optional[List[V2reportsMessage]] = None
    taxonomy_nodes: Optional[List[V2TaxonomyMatch]] = None
    __properties: ClassVar[List[str]] = ["messages", "taxonomy_nodes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in taxonomy_nodes (list)
        _items = []
        if self.taxonomy_nodes:
            for _item_taxonomy_nodes in self.taxonomy_nodes:
                if _item_taxonomy_nodes:
                    _items.append(_item_taxonomy_nodes.to_dict())
            _dict['taxonomy_nodes'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "taxonomy_nodes": [V2TaxonomyMatch.from_dict(_item) for _item in obj["taxonomy_nodes"]] if obj.get("taxonomy_nodes") is not None else None
        })
        return _obj
