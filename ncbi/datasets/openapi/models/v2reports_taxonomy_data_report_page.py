...
class V2reportsTaxonomyDataReportPage(BaseModel):
    ...
    """ # noqa: E501
    reports: Optional[List[V2reportsTaxonomyReportMatch]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reports": [V2reportsTaxonomyReportMatch.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None,
