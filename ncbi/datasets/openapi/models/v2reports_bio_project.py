...
class V2reportsBioProject(BaseModel):
    ...
    parent_accession: Optional[StrictStr] = None
    parent_accessions: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["accession", "title", "parent_accession", "parent_accessions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "title": obj.get("title"),
            "parent_accession": obj.get("parent_accession"),
            "parent_accessions": obj.get("parent_accessions")
        })
        return _obj
