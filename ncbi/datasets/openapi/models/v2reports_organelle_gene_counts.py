...
class V2reportsOrganelleGeneCounts(BaseModel):
    ...
    rrna: Optional[StrictInt] = None
    trna: Optional[StrictInt] = None
    lncrna: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["total", "protein_coding", "rrna", "trna", "lncrna"]
