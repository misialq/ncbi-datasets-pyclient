...
class V2reportsProcessMetadata(BaseModel):
    ...
    go_id: Optional[StrictStr] = None
    evidence_code: Optional[StrictStr] = None
    qualifier: Optional[StrictStr] = None
    reference: Optional[V2reportsReference] = None
    __properties: ClassVar[List[str]] = ["name", "go_id", "evidence_code", "qualifier", "reference"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reference": V2reportsReference.from_dict(obj["reference"]) if obj.get("reference") is not None else None
        })
        return _obj
