...
class V2AssemblyDatasetAvailability(BaseModel):
    """
    V2AssemblyDatasetAvailability
    """ # noqa: E501
    valid_assemblies: Optional[List[StrictStr]] = None
    invalid_assemblies: Optional[List[StrictStr]] = None
    reason: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["valid_assemblies", "invalid_assemblies", "reason"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "valid_assemblies": obj.get("valid_assemblies"),
            "invalid_assemblies": obj.get("invalid_assemblies"),
