...
class V2archiveAffiliation(BaseModel):
    """
    V2archiveAffiliation
    """ # noqa: E501
    affiliation: Optional[StrictStr] = None
    division: Optional[StrictStr] = None
    location: Optional[V2archiveLocation] = None
    __properties: ClassVar[List[str]] = ["affiliation", "division", "location"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "location": V2archiveLocation.from_dict(obj["location"]) if obj.get("location") is not None else None
        })
        return _obj
