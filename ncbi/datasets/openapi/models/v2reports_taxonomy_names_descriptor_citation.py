...
class V2reportsTaxonomyNamesDescriptorCitation(BaseModel):
    ...
    """ # noqa: E501
    full_citation: Optional[StrictStr] = None
    short_citation: Optional[StrictStr] = None
    pmid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["full_citation", "short_citation", "pmid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "full_citation": obj.get("full_citation"),
            "short_citation": obj.get("short_citation"),
            "pmid": obj.get("pmid")
        })
        return _obj
