...
class V2reportsTypeMaterial(BaseModel):
    """
    V2reportsTypeMaterial
    """ # noqa: E501
    type_label: Optional[StrictStr] = None
    type_display_text: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["type_label", "type_display_text"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type_display_text": obj.get("type_display_text")
        })
        return _obj
