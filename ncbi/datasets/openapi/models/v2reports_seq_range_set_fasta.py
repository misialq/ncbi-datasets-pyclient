...
class V2reportsSeqRangeSetFasta(BaseModel):
    ...
    sequence_hash: Optional[StrictStr] = None
    range: Optional[List[V2reportsRange]] = None
    __properties: ClassVar[List[str]] = ["seq_id", "accession_version", "title", "sequence_hash", "range"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "title": obj.get("title"),
            "sequence_hash": obj.get("sequence_hash"),
