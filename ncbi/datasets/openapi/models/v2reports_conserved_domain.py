...
class V2reportsConservedDomain(BaseModel):
    ...
    range: Optional[V2reportsRange] = None
    __properties: ClassVar[List[str]] = ["accession", "name", "range"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "range": V2reportsRange.from_dict(obj["range"]) if obj.get("range") is not None else None
        })
        return _obj
