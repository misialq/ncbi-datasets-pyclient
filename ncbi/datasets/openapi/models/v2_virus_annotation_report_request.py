...
class V2VirusAnnotationReportRequest(BaseModel):
    """
    V2VirusAnnotationReportRequest
    """ # noqa: E501
    filter: Optional[V2VirusAnnotationFilter] = None
    table_fields: Optional[List[StrictStr]] = None
    table_format: Optional[StrictStr] = None
    page_size: Optional[StrictInt] = None
    page_token: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["filter", "table_fields", "table_format", "page_size", "page_token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": V2VirusAnnotationFilter.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
