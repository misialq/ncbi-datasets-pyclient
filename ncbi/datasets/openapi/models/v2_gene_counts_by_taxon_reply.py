...
class V2GeneCountsByTaxonReply(BaseModel):
    ...
    """ # noqa: E501
    report: Optional[List[V2GeneCountsByTaxonReplyGeneTypeAndCount]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "report": [V2GeneCountsByTaxonReplyGeneTypeAndCount.from_dict(_item) for _item in obj["report"]] if obj.get("report") is not None else None
        })
        return _obj
