...
class V2reportsMessage(BaseModel):
    ...
    V2reportsMessage
    """ # noqa: E501
    error: Optional[V2reportsError] = None
    warning: Optional[V2reportsWarning] = None
    __properties: ClassVar[List[str]] = ["error", "warning"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": V2reportsError.from_dict(obj["error"]) if obj.get("error") is not None else None,
