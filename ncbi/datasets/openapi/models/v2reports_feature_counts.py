...
class V2reportsFeatureCounts(BaseModel):
    ...
    """ # noqa: E501
    gene_counts: Optional[V2reportsGeneCounts] = None
    __properties: ClassVar[List[str]] = ["gene_counts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gene_counts": V2reportsGeneCounts.from_dict(obj["gene_counts"]) if obj.get("gene_counts") is not None else None
        })
        return _obj
