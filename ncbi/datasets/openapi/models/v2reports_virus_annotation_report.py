...
class V2reportsVirusAnnotationReport(BaseModel):
    """
    V2reportsVirusAnnotationReport
    """ # noqa: E501
    accession: Optional[StrictStr] = None
    isolate_name: Optional[StrictStr] = None
    genes: Optional[List[V2reportsVirusGene]] = None
    __properties: ClassVar[List[str]] = ["accession", "isolate_name", "genes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "genes": [V2reportsVirusGene.from_dict(_item) for _item in obj["genes"]] if obj.get("genes") is not None else None
        })
        return _obj
