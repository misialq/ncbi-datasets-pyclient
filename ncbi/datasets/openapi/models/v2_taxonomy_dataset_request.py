...
class V2TaxonomyDatasetRequest(BaseModel):
    ...
    """ # noqa: E501
    tax_ids: Optional[List[StrictInt]] = None
    aux_reports: Optional[List[V2TaxonomyDatasetRequestTaxonomyReportType]] = None
    __properties: ClassVar[List[str]] = ["tax_ids", "aux_reports"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tax_ids": obj.get("tax_ids"),
            "aux_reports": obj.get("aux_reports")
        })
        return _obj
