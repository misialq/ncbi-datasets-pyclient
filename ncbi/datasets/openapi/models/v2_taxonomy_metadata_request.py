...
class V2TaxonomyMetadataRequest(BaseModel):
    ...
    returned_content: Optional[V2TaxonomyMetadataRequestContentType] = V2TaxonomyMetadataRequestContentType.COMPLETE
    ...
    table_format: Optional[V2TaxonomyMetadataRequestTableFormat] = V2TaxonomyMetadataRequestTableFormat.SUMMARY
    children: Optional[StrictBool] = None
    ranks: Optional[List[V2reportsRankType]] = None
    __properties: ClassVar[List[str]] = ["taxons", "returned_content", "page_size", "include_tabular_header", "page_token", "table_format", "children", "ranks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "returned_content": obj.get("returned_content") if obj.get("returned_content") is not None else V2TaxonomyMetadataRequestContentType.COMPLETE,
            ...
            "table_format": obj.get("table_format") if obj.get("table_format") is not None else V2TaxonomyMetadataRequestTableFormat.SUMMARY,
