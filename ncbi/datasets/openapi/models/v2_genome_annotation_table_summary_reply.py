...
class V2GenomeAnnotationTableSummaryReply(BaseModel):
    ...
    empty_columns: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["accession", "chromosomes", "gene_types", "empty_columns"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "empty_columns": obj.get("empty_columns")
        })
        return _obj
