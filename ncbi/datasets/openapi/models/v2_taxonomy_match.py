...
class V2TaxonomyMatch(BaseModel):
    """
    V2TaxonomyMatch
    """ # noqa: E501
    ...
    taxonomy: Optional[V2TaxonomyNode] = None
    __properties: ClassVar[List[str]] = ["warnings", "errors", "query", "taxonomy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "query": obj.get("query"),
            "taxonomy": V2TaxonomyNode.from_dict(obj["taxonomy"]) if obj.get("taxonomy") is not None else None
        })
        return _obj
