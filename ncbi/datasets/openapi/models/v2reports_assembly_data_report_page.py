...
class V2reportsAssemblyDataReportPage(BaseModel):
    ...
    """ # noqa: E501
    reports: Optional[List[V2reportsAssemblyDataReport]] = None
    content_type: Optional[V2reportsContentType] = V2reportsContentType.COMPLETE
    total_count: Optional[StrictInt] = None
    next_page_token: Optional[StrictStr] = None
    messages: Optional[List[V2reportsMessage]] = None
    __properties: ClassVar[List[str]] = ["reports", "content_type", "total_count", "next_page_token", "messages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reports": [V2reportsAssemblyDataReport.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None,
            "content_type": obj.get("content_type") if obj.get("content_type") is not None else V2reportsContentType.COMPLETE,
