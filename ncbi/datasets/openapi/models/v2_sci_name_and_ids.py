...
class V2SciNameAndIds(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.sci_name_and_ids:
            for _item_sci_name_and_ids in self.sci_name_and_ids:
                if _item_sci_name_and_ids:
                    _items.append(_item_sci_name_and_ids.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sci_name_and_ids": [V2SciNameAndIdsSciNameAndId.from_dict(_item) for _item in obj["sci_name_and_ids"]] if obj.get("sci_name_and_ids") is not None else None
        })
        return _obj
