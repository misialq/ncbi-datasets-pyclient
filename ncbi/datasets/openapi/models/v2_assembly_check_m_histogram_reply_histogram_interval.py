...
class V2AssemblyCheckMHistogramReplyHistogramInterval(BaseModel):
    ...
    """ # noqa: E501
    start_pos: Optional[Union[StrictFloat, StrictInt]] = None
    stop_pos: Optional[Union[StrictFloat, StrictInt]] = None
    count: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["start_pos", "stop_pos", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "start_pos": obj.get("start_pos"),
            "stop_pos": obj.get("stop_pos"),
            "count": obj.get("count")
        })
        return _obj
