...
class V2reportsVirusGene(BaseModel):
    """
    V2reportsVirusGene
    """ # noqa: E501
    ...
    cds: Optional[List[V2reportsVirusPeptide]] = None
    __properties: ClassVar[List[str]] = ["name", "gene_id", "nucleotide", "cds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in cds (list)
        _items = []
        if self.cds:
            for _item_cds in self.cds:
                if _item_cds:
                    _items.append(_item_cds.to_dict())
            _dict['cds'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cds": [V2reportsVirusPeptide.from_dict(_item) for _item in obj["cds"]] if obj.get("cds") is not None else None
        })
        return _obj
