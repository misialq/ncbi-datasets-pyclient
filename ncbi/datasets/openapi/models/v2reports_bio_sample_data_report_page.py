...
class V2reportsBioSampleDataReportPage(BaseModel):
    """
    V2reportsBioSampleDataReportPage
    """ # noqa: E501
    reports: Optional[List[V2reportsBioSampleDataReport]] = None
    total_count: Optional[StrictInt] = None
    next_page_token: Optional[StrictStr] = None
    messages: Optional[List[V2reportsMessage]] = None
    __properties: ClassVar[List[str]] = ["reports", "total_count", "next_page_token", "messages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reports": [V2reportsBioSampleDataReport.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None,
