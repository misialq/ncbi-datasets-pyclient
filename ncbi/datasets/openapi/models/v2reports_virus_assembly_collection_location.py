...
class V2reportsVirusAssemblyCollectionLocation(BaseModel):
    ...
    """ # noqa: E501
    geographic_location: Optional[StrictStr] = None
    geographic_region: Optional[StrictStr] = None
    usa_state: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["geographic_location", "geographic_region", "usa_state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "geographic_location": obj.get("geographic_location"),
            "geographic_region": obj.get("geographic_region"),
