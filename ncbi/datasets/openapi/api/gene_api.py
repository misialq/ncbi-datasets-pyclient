...
class GeneApi:
    ...
    @validate_call
    def gene_expression_report(
        self,
        ncbieukgenev2_gene_id_request: Ncbieukgenev2GeneIdRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param ncbieukgenev2_gene_id_request: (required)
        :type ncbieukgenev2_gene_id_request: Ncbieukgenev2GeneIdRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._gene_expression_report_serialize(
            ncbieukgenev2_gene_id_request=ncbieukgenev2_gene_id_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def gene_expression_report_with_http_info(
        self,
        ncbieukgenev2_gene_id_request: Ncbieukgenev2GeneIdRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def gene_expression_report_without_preload_content(
        self,
        ncbieukgenev2_gene_id_request: Ncbieukgenev2GeneIdRequest,
        _request_timeout: Union[
            None,
    ...
    def _gene_expression_report_serialize(
        self,
        ncbieukgenev2_gene_id_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if ncbieukgenev2_gene_id_request is not None:
            _body_params = ncbieukgenev2_gene_id_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/gene/expression_report',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def gene_expression_reports_by_id(
        self,
        ...
        _param = self._gene_expression_reports_by_id_serialize(
            gene_ids=gene_ids,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def gene_expression_reports_by_id_with_http_info(
        self,
        gene_ids: Annotated[List[StrictInt], Field(description="NCBI gene ids, limited to 1000 ids")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def gene_expression_reports_by_id_without_preload_content(
        self,
        gene_ids: Annotated[List[StrictInt], Field(description="NCBI gene ids, limited to 1000 ids")],
        _request_timeout: Union[
            None,
    ...
    def _gene_expression_reports_by_id_serialize(
        self,
        gene_ids,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/gene/id/{gene_ids}/expression_report',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
