...
class BioSampleApi:
    ...
    def bio_sample_dataset_report(
        ...
        _param = self._bio_sample_dataset_report_serialize(
    ...
    @validate_call
    def bio_sample_dataset_report_with_http_info(
        self,
        accessions: List[StrictStr],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def bio_sample_dataset_report_without_preload_content(
        self,
        accessions: List[StrictStr],
        _request_timeout: Union[
            None,
    ...
    def _bio_sample_dataset_report_serialize(
        self,
        accessions,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/biosample/accession/{accessions}/biosample_report',
