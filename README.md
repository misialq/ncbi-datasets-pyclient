...
*GeneApi* | [**gene_expression_report**](docs/GeneApi.md#gene_expression_report) | **POST** /gene/expression_report | Get a gene expression report
*GeneApi* | [**gene_expression_reports_by_id**](docs/GeneApi.md#gene_expression_reports_by_id) | **GET** /gene/id/{gene_ids}/expression_report | Get a gene expression report by GeneID
...
*TaxonomyApi* | [**taxonomy_metadata_post**](docs/TaxonomyApi.md#taxonomy_metadata_post) | **POST** /taxonomy | Get taxonomy metadata by taxon
...
## Documentation For Models
 ...
 - [Ncbieukgenev2GeneIdRequest](docs/Ncbieukgenev2GeneIdRequest.md)
 ...
 - [V2BiocollectionsSortField](docs/V2BiocollectionsSortField.md)
 ...
 - [V2GetBiocollectionsRequest](docs/V2GetBiocollectionsRequest.md)
 ...
 - [V2PubmedList](docs/V2PubmedList.md)
 ...
 - [V2SequenceDatasetRequest](docs/V2SequenceDatasetRequest.md)
 - [V2SequenceDatasetRequestFileType](docs/V2SequenceDatasetRequestFileType.md)
 - [V2SequenceReportPage](docs/V2SequenceReportPage.md)
 - [V2SequenceRequest](docs/V2SequenceRequest.md)
 - [V2SequenceRequestContentType](docs/V2SequenceRequestContentType.md)
 - [V2SequenceRequestTableFormat](docs/V2SequenceRequestTableFormat.md)
 ...
 - [V2reportsAggregateExpressionValue](docs/V2reportsAggregateExpressionValue.md)
 - [V2reportsAnnotation](docs/V2reportsAnnotation.md)
 - [V2reportsAnnotationInfo](docs/V2reportsAnnotationInfo.md)
 - [V2reportsArticle](docs/V2reportsArticle.md)
 ...
 - [V2reportsAuthor](docs/V2reportsAuthor.md)
 ...
 - [V2reportsBioSample](docs/V2reportsBioSample.md)
 ...
 - [V2reportsBiocollection](docs/V2reportsBiocollection.md)
 - [V2reportsBiocollectionInstitution](docs/V2reportsBiocollectionInstitution.md)
 - [V2reportsBiocollectionsReportPage](docs/V2reportsBiocollectionsReportPage.md)
 - [V2reportsBook](docs/V2reportsBook.md)
 ...
 - [V2reportsCultureCollection](docs/V2reportsCultureCollection.md)
 ...
 - [V2reportsErrorSequenceErrorCode](docs/V2reportsErrorSequenceErrorCode.md)
 ...
 - [V2reportsExpressionBioProject](docs/V2reportsExpressionBioProject.md)
 - [V2reportsExpressionDescriptor](docs/V2reportsExpressionDescriptor.md)
 - [V2reportsExpressionRelease](docs/V2reportsExpressionRelease.md)
 ...
 - [V2reportsGeneNeighbor](docs/V2reportsGeneNeighbor.md)
 - [V2reportsGeneNeighborGenomicLocation](docs/V2reportsGeneNeighborGenomicLocation.md)
 - [V2reportsGeneNeighborsAnnotation](docs/V2reportsGeneNeighborsAnnotation.md)
 - [V2reportsGeneNeighborsDescriptor](docs/V2reportsGeneNeighborsDescriptor.md)
 - [V2reportsGeneNeighborsReports](docs/V2reportsGeneNeighborsReports.md)
 ...
 - [V2reportsGeneral](docs/V2reportsGeneral.md)
 - [V2reportsGeneticCode](docs/V2reportsGeneticCode.md)
 - [V2reportsGeneticCodes](docs/V2reportsGeneticCodes.md)
 ...
 - [V2reportsGetBiocollectionsReport](docs/V2reportsGetBiocollectionsReport.md)
 - [V2reportsInfraspecificModifers](docs/V2reportsInfraspecificModifers.md)
 - [V2reportsInfraspecificNames](docs/V2reportsInfraspecificNames.md)
 - [V2reportsIsolate](docs/V2reportsIsolate.md)
 - [V2reportsIsolationDetails](docs/V2reportsIsolationDetails.md)
 - [V2reportsJournal](docs/V2reportsJournal.md)
 ...
 - [V2reportsMapLocation](docs/V2reportsMapLocation.md)
 - [V2reportsMapLocationMapType](docs/V2reportsMapLocationMapType.md)
 - [V2reportsMaturePeptide](docs/V2reportsMaturePeptide.md)
 - [V2reportsMedline](docs/V2reportsMedline.md)
 - [V2reportsMedlineStatus](docs/V2reportsMedlineStatus.md)
 - [V2reportsMeeting](docs/V2reportsMeeting.md)
 - [V2reportsMessage](docs/V2reportsMessage.md)
 - [V2reportsMoleculeType](docs/V2reportsMoleculeType.md)
 ...
 - [V2reportsPatent](docs/V2reportsPatent.md)
 - [V2reportsProceedings](docs/V2reportsProceedings.md)
 ...
 - [V2reportsProteinNameEvidence](docs/V2reportsProteinNameEvidence.md)
 ...
 - [V2reportsSample](docs/V2reportsSample.md)
 - [V2reportsSampleInfo](docs/V2reportsSampleInfo.md)
 - [V2reportsSeqRangeSet](docs/V2reportsSeqRangeSet.md)
 - [V2reportsSeqRangeSetFasta](docs/V2reportsSeqRangeSetFasta.md)
 - [V2reportsSequenceDataReport](docs/V2reportsSequenceDataReport.md)
 - [V2reportsSequenceDataReportCompleteness](docs/V2reportsSequenceDataReportCompleteness.md)
 - [V2reportsSequenceDataReportGenomeType](docs/V2reportsSequenceDataReportGenomeType.md)
 - [V2reportsSequenceDataReportMatch](docs/V2reportsSequenceDataReportMatch.md)
 - [V2reportsSequenceDataReportOriginType](docs/V2reportsSequenceDataReportOriginType.md)
 - [V2reportsSequenceDataReportPage](docs/V2reportsSequenceDataReportPage.md)
 - [V2reportsSequenceDataReportSequencingMethod](docs/V2reportsSequenceDataReportSequencingMethod.md)
 - [V2reportsSequenceDataReportTopologyType](docs/V2reportsSequenceDataReportTopologyType.md)
 - [V2reportsSequenceDataReportUnits](docs/V2reportsSequenceDataReportUnits.md)
 - [V2reportsSequenceInfo](docs/V2reportsSequenceInfo.md)
 - [V2reportsSequenceInformation](docs/V2reportsSequenceInformation.md)
 - [V2reportsSequenceReference](docs/V2reportsSequenceReference.md)
 - [V2reportsSequenceTypeMaterial](docs/V2reportsSequenceTypeMaterial.md)
 - [V2reportsSourceDatabase](docs/V2reportsSourceDatabase.md)
 - [V2reportsSpecimenVoucher](docs/V2reportsSpecimenVoucher.md)
 - [V2reportsSraRun](docs/V2reportsSraRun.md)
 - [V2reportsSubmission](docs/V2reportsSubmission.md)
 ...
 - [V2reportsThesis](docs/V2reportsThesis.md)
 - [V2reportsThesisType](docs/V2reportsThesisType.md)
